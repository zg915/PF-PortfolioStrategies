...
def μ_transition_function(μ̄, ϕ_μ, σ_μ, η_μ, μ_t):
    particles = μ̄ + ϕ_μ * (μ_t - μ̄) + σ_μ * η_μ
    return particles
...
def SMSV(observation, L = 1_000_000, δ = 0.98):
    ...
    for t in tqdm(range(1, T, 1)):
        ...
        η[t] = N(0, 1, L)
        p_μ[t] = μ_transition_function(p_μ̄[t], p_ϕ_μ[t], p_σ_μ[t], η[t], μ[t-1])
...
if __name__ == "__main__":
    ...
    dates = returns.index
    y, AD1, AD2, AD3 = SMSV(observation, L = 1_000)
    print(AD1)
    print(AD2)
    print(AD3)
